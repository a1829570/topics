...
population = toolbox.population(n=50)  # Increased population size to 50
ngen, cxpb, mutpb = 30, 0.5, 0.2  # Increased number of generations to 30

# Hall of Fame to preserve the best individuals
hof = tools.HallOfFame(1)

algorithms.eaSimple(population, toolbox, cxpb, mutpb, ngen, stats=None, halloffame=hof)  # Run the GA optimization with Hall of Fame

# Step 3: Train the Multi-Layer Perceptron (MLP) with Optimized Hyperparameters
best_individual = hof[0]  # Use the best individual from the Hall of Fame
