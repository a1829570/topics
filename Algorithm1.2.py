...
def evaluate(individual):
    ...
    scores = cross_val_score(mlp, X_train, y_train, cv=3) # CHANGE 3
...
toolbox.register("attr_int", random.randint, 50, 150)  # Simplifying the model by reducing the number of neurons (50 to 150) CHANGE 2
# This reduces the complexity of the MLP, making it less prone to overfitting
toolbox.register("attr_float", random.uniform, 0.0001, 1.0)  # Register a float attribute for the alpha parameter (0.0001 to 1.0) CHANGE 1
